...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Adithyan Arun Kumar</h2>;
  const three = <h3 className="big-heading">I break and build code.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a className="email-link" href="https://blog.adithyanak.com" target="_blank" rel="noreferrer">
      Check out my blog!
    </a>
  );
